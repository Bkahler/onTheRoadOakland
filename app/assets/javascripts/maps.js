...
function initialize_map(){
	...
	if (mq.matches){
		var	map = new L.mapbox.map('map', 'panicbus.23p6efg5').setView([37.810661, -122.261213], 15); //set map center for desktop size
	} else {
		var	map = new L.mapbox.map('map', 'panicbus.23p6efg5').setView([37.810661, -122.261213], 14); //set map center for mobile size
	};
